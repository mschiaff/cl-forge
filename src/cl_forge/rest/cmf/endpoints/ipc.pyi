...
@overload
def ipc_endpoint(year: None = ..., month: None = ...) -> CmfEndpoint[IpcRecord]: ...
@overload
def ipc_endpoint(year: int, month: None = ...) -> CmfEndpoint[ListIpcRecord]: ...
@overload
def ipc_endpoint(year: int, month: int) -> CmfEndpoint[IpcRecord]: ...
@overload
@deprecated("Month cannot be specified without year.")
def ipc_endpoint(year: None = ..., month: int = ...) -> Never: ...
@overload
def ipc_endpoint(
        year: int | None = ...,
        month: int | None = ...
